...
double ROBOT_X_OFFSET = 13.5/2;     // robot width: 13.5 in
double ROBOT_Y_OFFSET = 17.5/2;     // robot length: 14 in + 3.5 in to tip of intake sled
...
void updatePosition() {
    ...
    sideEncValue = (sideEnc.get_position() / 100) * DRIVE_DEG_TO_INCH_275;
